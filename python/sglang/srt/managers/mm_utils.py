...
def general_mm_embed_routine(
    ...
    **kwargs,
    ...
    # Trace this forward pass with the real forward mode (prefill/decode/verify).
    # Using a hard-coded PREFILL here can cause overlapping PREFILL and DECODE spans.
